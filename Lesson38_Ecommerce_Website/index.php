<?php
    ...
    $sql = "SELECT * FROM products WHERE featured = 1 OR featured = 2 OR featured = 3 OR featured = 4";
        ...
        <div class="row">
            ...
            ?>
                <div class="col-md-5">
                    ...
                    ?>
                        <a href="details1.php">
                            <!-- 1.data-toggle：指以什麼事件觸發，相當於告訴瀏覽器你是一個什麼組件，
                            常用的如modal(模態框),popover(彈出框),tooltips(提示框)等。
                            2.data-target：指事件的設置目標，相當於告訴瀏覽器你要操作那個元素。
                            3.一起使用就是代表data-target所指的元素以data-toggle指定的形式顯示。 -->
